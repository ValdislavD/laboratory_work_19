...
void test_process_file() {
    ...
    fprintf(input1, "This is a test file for the longest word extraction.\n");
    ...
    // Проверка результата
    assert(compare_files(actual_output_file1, expected_output_file1) && "Test case 1 failed");
    ...
    assert(compare_files(actual_output_file2, expected_output_file2) && "Test case 2 failed");
